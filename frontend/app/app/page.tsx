        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            {activePhase === "deposit" && (
              <div className="card p-6 border border-white/10">
                <h2 className="text-2xl font-bold mb-4 font-tektur">
                  Phase 2: Deposit & Create Tickets
                </h2>
                <div className="space-y-4">
                  {/* Load Tickets Button */}
                  <button
            ...
            {activePhase === "swap" && (
              <div className="card p-6 border border-white/10">
                <h2 className="text-2xl font-bold mb-4 font-tektur">
                  Phase 3: Privacy-Preserving Swap
                </h2>
                <div className="space-y-4">
            ...
            <div className="card p-6 border border-white/10">
              ...
              <div className="space-y-3 text-sm font-anonymous-pro">
                ...
                <div>
                  ...
                  <span
                    className={`ml-2 ${
                      sealClient ? "text-gray-300" : "text-gray-500"
                    }`}
                  >
